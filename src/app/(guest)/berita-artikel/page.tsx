...
export default async function BeritaArtikelPage() {
  ...
  return (
    <main className="container min-h-screen w-full mx-auto">
      <Navbar />

      <section className="container mt-40 flex max-w-[64rem] flex-col items-center gap-4 text-center mx-auto w-full">
